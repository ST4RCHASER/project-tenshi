...
const VolleyballScoreManage = ({ id, data, socket, set }: Props) => {
    ...
    return (data.gameMeta.sets[set - 1].state != 4 && data.state != 4 ? <div>
        ...
        <div className='flex flex-col items-center justify-center text-3xl mb-4'>การแข่งเซ็ตนี้จบลงแล้ว</div>
        <Link href={`/game/${id}/sets`}>
            <Button
                color="indigo"
                buttonType="filled"
...
export default VolleyballScoreManage
