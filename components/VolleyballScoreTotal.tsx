...
const VolleyballScoreTotal = ({ id, data, socket }: Props) => {
    ...
    return (<div>
        <div className="bg-indigo-50 w-full shadow-lg mt-6 p-5 sm:p-10 border border-blue-100 rounded">
            ...
            <div className='grid grid-cols-7 gap-6 pl-16 pr-16'>
            ...
            <div className='grid grid-cols-7 gap-6 pl-16 pr-16 mt-4 text-xl'>
